...
class ControllerExtensionModuleOCdevSmartCart extends Controller {
  ...
  public function index() {
    ...
    if ($data['error_add_function_selector'] ||  $data['error_add_id_selector'] || $data['error_limit_cross_sell_products'] || $data['error_limit_up_sell_products'] ||  $data['error_heading'] || $data['error_call_button'] || $data['error_call_button_vs_options'] ||  $data['error_empty_text'] || $data['error_email_for_notification'] ){
