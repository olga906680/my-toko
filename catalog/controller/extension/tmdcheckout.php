...
class ControllerExtensionTmdcheckout extends Controller {
	...
	public function index() {
		...
		if($this->config->get('tmdqc_status')) {
			...
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('extension/tmdcheckout', '', true)
			...
			$this->document->addScript('catalog/view/javascript/jquery/datetimepicker/moment/moment-with-locales.min.js');
				...
				$this->document->addStyle('catalog/view/javascript/jquery/chkbox/checkbox.css');

				$this->document->addScript('catalog/view/javascript/jquery/chkbox/checkbox.js');
				...
				if($layout) {
					...
					$replace = array(
						...
						'<div class="col-lg-8 col-md-8 col-sm-12 padingleft">',

						'</div>',

						'<div class="col-lg-6 col-md-6 col-sm-12 padingleft">',

						'</div>',

						'<div class="col-lg-4 col-md-4 col-sm-12 pull-right padingright">',
						...
						'<div id="tmd_confirmation" class="col-sm-12"></div>',
				...
				$this->response->setOutput($this->load->view('extension/tmdcheckout', $data));
	...
	public function accounttype(){
		...
		$data['checkout_gueststatus'] = $this->config->get('tmdqc_guest_status');
		...
		$this->response->setOutput($this->load->view('extension/accounttype', $data));
	...
	public function edit() {
		...
		if (!empty($this->request->post['quantity'])) {
			...
			$this->response->redirect($this->url->link('extension/tmdcheckout'));
