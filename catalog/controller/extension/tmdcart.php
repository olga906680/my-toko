<?php
class ControllerExtensionTmdcart extends Controller {

	public function index() {
		$this->load->language('extension/tmdcart');
		...
		if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
		  ...
		  $data['entry_coupon'] = $this->language->get('entry_coupon');
			...
			$data['action'] = $this->url->link('extension/tmdcheckout/edit', '', true);
			...
			if (!empty($this->session->data['vouchers'])) {
				foreach ($this->session->data['vouchers'] as $key => $voucher) {
					$data['vouchers'][] = array(
						...
						'remove'      => $this->url->link('extension/tmdcheckout', 'remove=' . $key)
					);
				}
			}
			...
			$this->response->setOutput($this->load->view('extension/tmdcart', $data));
