...
class ControllerExtensionModuleUlogin extends Controller {
	...
	public function index($setting) {
		...
		$data['ulogin_form'] = $this->load->view('extension/module/ulogin/ulogin_form', $data);
		...
		if (empty($ulogin_type) && !$this->userIsLogged && !empty($ulogin_status)) {
			$tpl .= '/extension/module/ulogin/ulogin_form';

		} elseif (!$this->userIsLogged && $ulogin_type == 'offline') {
			$tpl .= '/extension/module/ulogin/ulogin_panel';
			...
			$tpl .= '/extension/module/ulogin/ulogin_profile';
	...
	public function messager() {
		...
		return $this->load->view('/extension/module/ulogin/ulogin_message', $data_message);
	}
